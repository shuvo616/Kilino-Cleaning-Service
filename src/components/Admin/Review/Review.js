...
const Review = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://blooming-springs-70688.herokuapp.com/addReview', {
            method: 'POST',
            body: formData
        })
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-9 col-sm-12">
                        <h4 className="mb-3 mt-3 text-center">Create Review</h4>
                        ...
                        <div className="rightSide">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-group">
                                    <label>Comment</label>
                                    <input onBlur={handleBlur} type="text" className="form-control" name="description" placeholder="Your Comment" />
                                </div>
                                <div className="form-group">
