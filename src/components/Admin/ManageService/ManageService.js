...
const ManageService = () => {
    ...
    const deleteService = (id) => {
        ...
        fetch("https://blooming-springs-70688.herokuapp.com/deleteService/" + id, {
            method: 'DELETE',
                            ...
                            <table>
                                ...
                                </tr>
                                {
                                    service.map(delService => <tr id="removeElement">
                                        ...
                                        <td> <button className="btn btn-danger" onClick={() => deleteService(delService._id)}>Delete</button> </td>
                                    </tr>)
                                }
                            </table>
                        </div>
